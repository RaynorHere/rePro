...
public class ListTester {
	...
	private void runTests() {
		...
		testSingleElementList(emptyList_add0_A_A, "emptyList_add0_A_A", LIST_A, STRING_A);	
		// ListIterator
		...
		testEmptyList(A_listIter1RemoveAfterPreviousA_emptyList, "A_listIter1RemoveAfterPreviousA_emptyList");
		...
		testTwoElementList(A_addAfterB_A_AB, "A_addAfterB_A_AB", LIST_AB, STRING_AB);
		testTwoElementList(A_addB_AB, "A_addB_AB", LIST_AB, STRING_AB);
		testTwoElementList(A_add0_B_BA, "A_add0_B_BA", LIST_BA, STRING_BA);
		testTwoElementList(A_add1_B_AB, "A_add1_B_AB", LIST_AB, STRING_AB);		
		// ListIterator
		testTwoElementList(A_listIterAddB_BA, "A_listIterAddB_BA", LIST_BA, STRING_BA);
		testTwoElementList(A_listIterAddAfterNextA_B_AB, "A_listIterAddAfterNextA_B_AB", LIST_AB, STRING_AB);
		testTwoElementList(A_listIterAddAfterPreviousA_B_BA, "A_listIterAddAfterPreviousA_B_BA", LIST_BA, STRING_BA);
		
		// 1-element to changed 1-element via set()
		testSingleElementList(A_set0_B_B, "A_set0_B_B", LIST_B, STRING_B);	
		// ListIterator
		testSingleElementList(A_listIterSetAfterNextA_B_B, "A_listIterSetAfterNextA_B_B", LIST_B, STRING_B);
		testSingleElementList(A_listIterSetAfterPreviousA_B_B, "A_listIterSetAfterPreviousA_B_B", LIST_B, STRING_B);
		...
		testSingleElementList(AB_listIter1RemoveAfterNextB_A, "AB_listIter1RemoveAfterNextB_A", LIST_A, STRING_A);
		testSingleElementList(AB_listIter2RemoveAfterPreviousB_A, "AB_listIter2RemoveAfterPreviousB_A", LIST_A, STRING_A);
		testSingleElementList(AB_listIter1RemoveAfterPreviousA_B, "AB_listIter1RemoveAfterPreviousA_B", LIST_B, STRING_B);
		...
		testThreeElementList(AB_addAfterC_A_ACB, "AB_addAfterC_A_ACB", LIST_ACB, STRING_ACB);
		testThreeElementList(AB_addAfterC_B_ABC, "AB_addAfterC_B_ABC", LIST_ABC, STRING_ABC);
		testThreeElementList(AB_add0_C_CAB, "AB_add0_C_CAB", LIST_CAB, STRING_CAB);
		testThreeElementList(AB_add1_C_ACB, "AB_add1_C_ACB", LIST_ACB, STRING_ACB);
		testThreeElementList(AB_add2_C_ABC, "AB_add2_C_ABC", LIST_ABC, STRING_ABC);	
		// ListIterator
		testThreeElementList(AB_listIterAddC_CAB, "AB_listIterAddC_CAB", LIST_CAB, STRING_CAB);
		testThreeElementList(AB_listIterAddAfterNextA_C_ACB, "AB_listIterAddAfterNextA_C_ACB", LIST_ACB, STRING_ACB);
		testThreeElementList(AB_listIterAddAfterNextB_C_ABC, "AB_listIterAddAfterNextB_C_ABC", LIST_ABC, STRING_ABC);
		testThreeElementList(AB_listIterAddAfterPreviousA_C_CAB, "AB_listIterAddAfterPreviousA_C_CAB", LIST_CAB, STRING_CAB);
		testThreeElementList(AB_listIterAddAfterPreviousB_C_ACB, "AB_listIterAddAfterPreviousB_C_ACB", LIST_ACB, STRING_ACB);
		
		// 2-element to changed 2-element via set()
		testTwoElementList(AB_set0_C_CB, "AB_set0_C_CB", LIST_CB, STRING_CB);
		testTwoElementList(AB_set1_C_AC, "AB_set1_C_AC", LIST_AC, STRING_AC);	
		// ListIterator
		testTwoElementList(AB_listIterSetAfterNextA_C_CB, "AB_listIterSetAfterNextA_C_CB", LIST_CB, STRING_CB);
		testTwoElementList(AB_listIterSetAfterNextB_C_AC, "AB_listIterSetAfterNextB_C_AC", LIST_AC, STRING_AC);
		testTwoElementList(AB_listIterSetAfterPreviousA_C_CB, "AB_listIterSetAfterPreviousA_C_CB", LIST_CB, STRING_CB);
		testTwoElementList(AB_listIterSetAfterPreviousB_C_AC, "AB_listIterSetAfterPreviousB_C_AC", LIST_AC, STRING_AC);
		...
		testTwoElementList(ABC_listIter1RemoveAfterNextB_AC, "ABC_listIter1RemoveAfterNextB_AC", LIST_AC, STRING_AC);
		testTwoElementList(ABC_listIter2RemoveAfterNextC_AB, "ABC_listIter2RemoveAfterNextC_AB", LIST_AB, STRING_AB);
		testTwoElementList(ABC_listIter3RemoveAfterPreviousC_AB, "ABC_listIter3RemoveAfterPreviousC_AB", LIST_AB, STRING_AB);
		testTwoElementList(ABC_listIter2RemoveAfterPreviousB_AC, "ABC_listIter2RemoveAfterPreviousB_AC", LIST_AC, STRING_AC);
		testTwoElementList(ABC_listIter1RemoveAfterPreviousA_BC, "ABC_listIter1RemoveAfterPreviousA_BC", LIST_BC, STRING_BC);
		
		
		// 3-element to changed 3-element via set()
		testThreeElementList(ABC_set0_D_DBC, "ABC_set0_D_DBC", LIST_DBC, STRING_DBC);
		testThreeElementList(ABC_set1_D_ADC, "ABC_set1_D_ADC", LIST_ADC, STRING_ADC);
		testThreeElementList(ABC_set2_D_ABD, "ABC_set2_D_ABD", LIST_ABD, STRING_ABD);
		// ListIterator
		testThreeElementList(ABC_listIterSetAfterNextA_D_DBC, "ABC_listIterSetAfterNextA_D_DBC", LIST_DBC, STRING_DBC);
		testThreeElementList(ABC_listIterSetAfterNextB_D_ADC, "ABC_listIterSetAfterNextB_D_ADC", LIST_ADC, STRING_ADC);
		testThreeElementList(ABC_listIterSetAfterNextC_D_ABD, "ABC_listIterSetAfterNextC_D_ABD", LIST_ABD, STRING_ABD);
		testThreeElementList(ABC_listIterSetAfterPreviousA_D_DBC, "ABC_listIterSetAfterPreviousA_D_DBC", LIST_DBC, STRING_DBC);
		testThreeElementList(ABC_listIterSetAfterPreviousB_D_ADC, "ABC_listIterSetAfterPreviousB_D_ADC", LIST_ADC, STRING_ADC);
		testThreeElementList(ABC_listIterSetAfterPreviousC_D_ABD, "ABC_listIterSetAfterPreviousC_D_ABD", LIST_ABD, STRING_ABD);
	...
	/** 
	 * EMPTY-LIST-TO-SINGLE-ELEMENT-LIST SCENARIOS 
	 */
	 ...
	 */
	private IndexedUnsortedList<Integer> emptyList_add0_A_A() {
		IndexedUnsortedList<Integer> list = newList();
		list.add(0,ELEMENT_A);
		return list;
	}
	private Scenario<Integer> emptyList_add0_A_A = () -> emptyList_add0_A_A();
	
	
	
	/**
	 * SINGLE-ELEMENT-LIST-TO-EMPTY-LIST SCENARIOS
	 */
	...
	/*
	 * SINGLE-ELEMENT-LIST-TO-SINGLE-ELEMENT-LIST SCENARIO
	 */
	
	/** Scenario: [A] -> set(0,B) -> [B]
	 * @return [B] after set(0,B)
	 */
	private IndexedUnsortedList<Integer> A_set0_B_B() {
		IndexedUnsortedList<Integer> list = emptyList_addA_A();
		list.set(0, ELEMENT_B);
		return list;
	}
	private Scenario<Integer> A_set0_B_B = () -> A_set0_B_B();
	
	
	
	/**
	 *  SINGLE-ELEMENT-LIST-TO-DOUBLE-ELEMENT-LIST SCENARIOS
	 */
	 ...
	 */
	private IndexedUnsortedList<Integer> A_addAfterB_A_AB() {
		IndexedUnsortedList<Integer> list = emptyList_addA_A();
		list.addAfter(ELEMENT_B, ELEMENT_A);
		return list;
	}
	private Scenario<Integer> A_addAfterB_A_AB = () -> A_addAfterB_A_AB();
	 ...
	 */
	private IndexedUnsortedList<Integer> A_add0_B_BA() {
		IndexedUnsortedList<Integer> list = emptyList_addA_A();
		list.add(0,ELEMENT_B);
		return list;
	}
	private Scenario<Integer> A_add0_B_BA = () -> A_add0_B_BA();
	
	/** Scenario: [A] -> add(1,B) -> [A,B]
	 * @return [A,B] after add(1,B)
	 */
	private IndexedUnsortedList<Integer> A_add1_B_AB() {
		IndexedUnsortedList<Integer> list = emptyList_addA_A();
		list.add(1,ELEMENT_B);
		return list;
	}
	private Scenario<Integer> A_add1_B_AB = () -> A_add1_B_AB();
	
	
	
	/** 
	 * DOUBLE-ELEMENT-LIST-TO-SINGLE-ELEMENT-LIST SCENARIOS
	 */
	...
	/**
	 * DOUBLE-ELEMENT-LIST-TO-DOUBLE-ELEMENT-LIST SCENARIOS
	 */
	
	/** Scenario: [A,B] -> set(0,C) -> [C,B]
	 * @return [C,B] after set(0,C)
	 */
	private IndexedUnsortedList<Integer> AB_set0_C_CB() {
		IndexedUnsortedList<Integer> list = A_addB_AB();
		list.set(0, ELEMENT_C);
		return list;
	}
	private Scenario<Integer> AB_set0_C_CB = () -> AB_set0_C_CB();
	
	/** Scenario: [A,B] -> set(1,C) -> [A,C]
	 * @return [A,C] after set(1,C)
	 */
	private IndexedUnsortedList<Integer> AB_set1_C_AC() {
		IndexedUnsortedList<Integer> list = A_addB_AB();
		list.set(1, ELEMENT_C);
		return list;
	}
	private Scenario<Integer> AB_set1_C_AC = () -> AB_set1_C_AC();
	
	
	
	/**
	 * DOUBLE-ELEMENT-LIST-TO-TRIPLE-ELEMENT-LIST SCENARIOS
	 */
	 ...
	 */
	private IndexedUnsortedList<Integer> AB_addAfterC_A_ACB() {
		IndexedUnsortedList<Integer> list = A_addB_AB();
		list.addAfter(ELEMENT_C, ELEMENT_A);
		return list;
	}
	private Scenario<Integer> AB_addAfterC_A_ACB = () -> AB_addAfterC_A_ACB();
	
	/** Scenario: [A,B] -> addAfter(C,B) -> [A,B,C]
	 * @return [A,B,C] after addAfter(C,B)
	 */
	private IndexedUnsortedList<Integer> AB_addAfterC_B_ABC() {
		IndexedUnsortedList<Integer> list = A_addB_AB();
		list.addAfter(ELEMENT_C, ELEMENT_B);
		return list;
	}
	private Scenario<Integer> AB_addAfterC_B_ABC = () -> AB_addAfterC_B_ABC();
	
	/** Scenario: [A,B] -> add(0,C) -> [C,A,B]
	 * @return [C,A,B] after add(0,C)
	 */
	private IndexedUnsortedList<Integer> AB_add0_C_CAB() {
		IndexedUnsortedList<Integer> list = A_addB_AB();
		list.add(0,ELEMENT_C);
		return list;
	}
	private Scenario<Integer> AB_add0_C_CAB = () -> AB_add0_C_CAB();
	
	/** Scenario: [A,B] -> add(1,C) -> [A,C,B]
	 * @return [A,C,B] after add(1,C)
	 */
	private IndexedUnsortedList<Integer> AB_add1_C_ACB() {
		IndexedUnsortedList<Integer> list = A_addB_AB();
		list.add(1,ELEMENT_C);
		return list;
	}
	private Scenario<Integer> AB_add1_C_ACB = () -> AB_add1_C_ACB();
	
	/** Scenario: [A,B] -> add(2,C) -> [A,B,C]
	 * @return [A,B,C] after add(2,C)
	 */
	private IndexedUnsortedList<Integer> AB_add2_C_ABC() {
		IndexedUnsortedList<Integer> list = A_addB_AB();
		list.add(2,ELEMENT_C);
		return list;
	}
	private Scenario<Integer> AB_add2_C_ABC = () -> AB_add2_C_ABC();
	
	
	
	/**
	 * TRIPLE-ELEMENT-LIST-TO-DOUBLE-ELEMENT-LIST SCENARIOS
	 */
	...
	/**
	 * TRIPLE-ELEMENT-LIST-TO-TRIPLE-ELEMENT-LIST SCENARIOS
	 */
	
	/** Scenario: [A,B,C] -> set(0,D) -> [D,B,C]
	 * @return [D,B,C] after set(0,D)
	 */
	private IndexedUnsortedList<Integer> ABC_set0_D_DBC() {
		IndexedUnsortedList<Integer> list = AB_addC_ABC();
		list.set(0, ELEMENT_D);
		return list;
	}
	private Scenario<Integer> ABC_set0_D_DBC = () -> ABC_set0_D_DBC();
	
	/** Scenario: [A,B,C] -> set(1,D) -> [A,D,C]
	 * @return [A,D,C] after set(1,D)
	 */
	private IndexedUnsortedList<Integer> ABC_set1_D_ADC() {
		IndexedUnsortedList<Integer> list = AB_addC_ABC();
		list.set(1, ELEMENT_D);
		return list;
	}
	private Scenario<Integer> ABC_set1_D_ADC = () -> ABC_set1_D_ADC();
	
	/** Scenario: [A,B,C] -> set(2,D) -> [A,B,D]
	 * @return [A,B,D] after set(2,D)
	 */
	private IndexedUnsortedList<Integer> ABC_set2_D_ABD() {
		IndexedUnsortedList<Integer> list = AB_addC_ABC();
		list.set(2, ELEMENT_D);
		return list;
	}
	private Scenario<Integer> ABC_set2_D_ABD = () -> ABC_set2_D_ABD();
	
	
	
	/** 
	 *  ITERATOR-MODIFIED-LIST SCENARIOS
	 */
	 ...
	 * @return [A] after iteratorRemoveAfterNextNextB
	 */
	...
	/** Scenario: [A,B,C] -> iteratorRemoveAfterNextNextNextC -> [A,B]
	 * @return [A,B] after iteratorRemoveAfterNextNextNextC
	 */
	...
	/**
	 * LIST ITERATOR-MODIFIED SCENARIOS
	 */
	...
	/** Scenario: [A,B] -> listIter1RemoveAfterNextB -> [A]
	 * @return [A] after listIter1RemoveAfterNextB
	 */
	private IndexedUnsortedList<Integer> AB_listIter1RemoveAfterNextB_A() {
		IndexedUnsortedList<Integer> list = A_addB_AB();
	...
	private Scenario<Integer> AB_listIter1RemoveAfterNextB_A = () -> AB_listIter1RemoveAfterNextB_A();
	...
	/** Scenario: [A,B,C] -> listIter1RemoveAfterNextB -> [A,C]
	 * @return [A,C] after listIter1RemoveAfterNextB
	 */
	private IndexedUnsortedList<Integer> ABC_listIter1RemoveAfterNextB_AC() {
		IndexedUnsortedList<Integer> list = AB_addC_ABC();
		ListIterator<Integer> it = list.listIterator(1);
		it.next();
		it.remove();
	...
	private Scenario<Integer> ABC_listIter1RemoveAfterNextB_AC = () -> ABC_listIter1RemoveAfterNextB_AC();
	
	/** Scenario: [A,B,C] -> listIter2RemoveAfterNextNextNextC -> [A,B]
	 * @return [A,B] after listIter2RemoveAfterNextNextNextC
	 */
	private IndexedUnsortedList<Integer> ABC_listIter2RemoveAfterNextC_AB() {
		IndexedUnsortedList<Integer> list = AB_addC_ABC();
	...
	private Scenario<Integer> ABC_listIter2RemoveAfterNextC_AB = () -> ABC_listIter2RemoveAfterNextC_AB();
	...
	/**
	 * SINGLE-TO-EMPTY LIST
	 */
	
	/** Scenario: [A] -> listIter1RemoveAfterPreviousA -> []
	 * @return [] after listIter1RemoveAfterPreviousA
	 */
	private IndexedUnsortedList<Integer> A_listIter1RemoveAfterPreviousA_emptyList() {
		IndexedUnsortedList<Integer> list = emptyList_addA_A();
		ListIterator<Integer> it = list.listIterator(1);
		it.previous();
		it.remove();
	...
	private Scenario<Integer> A_listIter1RemoveAfterPreviousA_emptyList = () -> A_listIter1RemoveAfterPreviousA_emptyList();
	...
	/** Scenario: [A,B] -> listIter2RemoveAfterPreviousB -> [A]
	 * @return [A] after listIter2RemoveAfterPreviousB
	 */
	private IndexedUnsortedList<Integer> AB_listIter2RemoveAfterPreviousB_A() {
		IndexedUnsortedList<Integer> list = A_addB_AB();
		ListIterator<Integer> it = list.listIterator(2);
		it.previous();
		it.remove();
	...
	private Scenario<Integer> AB_listIter2RemoveAfterPreviousB_A = () -> AB_listIter2RemoveAfterPreviousB_A();
	
	/** Scenario: [A,B] -> listIter1RemoveAfterPreviousPreviousA -> [B]
	 * @return [B] after listIter1RemoveAfterPreviousPreviousA
	 */
	private IndexedUnsortedList<Integer> AB_listIter1RemoveAfterPreviousA_B() {
		IndexedUnsortedList<Integer> list = A_addB_AB();
		ListIterator<Integer> it = list.listIterator(1);
		it.previous();
		it.remove();
	...
	private Scenario<Integer> AB_listIter1RemoveAfterPreviousA_B = () -> AB_listIter1RemoveAfterPreviousA_B();
	...
	/** Scenario: [A,B,C] -> listIter3RemoveAfterPreviousC -> [A,B]
	 * @return [A,B] after listIter3RemoveAfterPreviousC 
	 */
	private IndexedUnsortedList<Integer> ABC_listIter3RemoveAfterPreviousC_AB() {
		IndexedUnsortedList<Integer> list = AB_addC_ABC();
	...
	private Scenario<Integer> ABC_listIter3RemoveAfterPreviousC_AB = () -> ABC_listIter3RemoveAfterPreviousC_AB();
	
	/** Scenario: [A,B,C] -> listIter2RemoveAfterPreviousB -> [A,C]
	 * @return [A,C] after listIter2RemoveAfterPreviousB
	 */
	private IndexedUnsortedList<Integer> ABC_listIter2RemoveAfterPreviousB_AC() {
		IndexedUnsortedList<Integer> list = AB_addC_ABC();
		ListIterator<Integer> it = list.listIterator(2);
		it.previous();
		it.remove();
	...
	private Scenario<Integer> ABC_listIter2RemoveAfterPreviousB_AC = () -> ABC_listIter2RemoveAfterPreviousB_AC();
	
	/** Scenario: [A,B,C] -> listIter1RemoveAfterPreviousA -> [B,C]
	 * @return [B,C] after listIter1RemoveAfterPreviousA
	 */
	private IndexedUnsortedList<Integer> ABC_listIter1RemoveAfterPreviousA_BC() {
		IndexedUnsortedList<Integer> list = AB_addC_ABC();
		ListIterator<Integer> it = list.listIterator(1);
		it.previous();
		it.remove();
	...
	private Scenario<Integer> ABC_listIter1RemoveAfterPreviousA_BC = () -> ABC_listIter1RemoveAfterPreviousA_BC();
	...
	/** Scenario: [A] -> listIterAddAfterNextA(B) -> [A,B]
	 * @return [A,B] after listIterAddAfterNextA(B)
	 */
	private IndexedUnsortedList<Integer> A_listIterAddAfterNextA_B_AB() {
		IndexedUnsortedList<Integer> list = emptyList_addA_A();
		ListIterator<Integer> it = list.listIterator();
		it.next();
		it.add(ELEMENT_B);
	...
	private Scenario<Integer> A_listIterAddAfterNextA_B_AB = () -> A_listIterAddAfterNextA_B_AB();
	
	/** Scenario: [A] -> listIterAddAfterPreviousA(B) -> [B,A]
	 * @return [B,A] after listIterAddAfterPreviousA(B)
	 */
	private IndexedUnsortedList<Integer> A_listIterAddAfterPreviousA_B_BA() {
		IndexedUnsortedList<Integer> list = emptyList_addA_A();
		ListIterator<Integer> it = list.listIterator(1);
		it.previous();
		it.add(ELEMENT_B);
	...
	private Scenario<Integer> A_listIterAddAfterPreviousA_B_BA = () -> A_listIterAddAfterPreviousA_B_BA();
	...
	/** Scenario: [A,B] -> listIterAdd(C) -> [C,A,B]
	 * @return [C,A,B] after listIterAdd(C)
	 */
	...
	/** Scenario: [A,B] -> listIterAddAfterNextA(C) -> [A,C,B]
	 * @return [A,C,B] after listIterAddAfterNextA(C)
	 */
	private IndexedUnsortedList<Integer> AB_listIterAddAfterNextA_C_ACB() {
		IndexedUnsortedList<Integer> list = A_addB_AB();
		ListIterator<Integer> it = list.listIterator();
		it.next();
		it.add(ELEMENT_C);
	...
	private Scenario<Integer> AB_listIterAddAfterNextA_C_ACB = () -> AB_listIterAddAfterNextA_C_ACB();
	
	
	/** Scenario: [A,B] -> listIterAddAfterNextB(C) -> [A,B,C]
	 * @return [A,B,C] after listIterAddAfterNextB(C)
	 */
	private IndexedUnsortedList<Integer> AB_listIterAddAfterNextB_C_ABC() {
		IndexedUnsortedList<Integer> list = A_addB_AB();
		ListIterator<Integer> it = list.listIterator(1);
		it.next();
		it.add(ELEMENT_C);
	...
	private Scenario<Integer> AB_listIterAddAfterNextB_C_ABC = () -> AB_listIterAddAfterNextB_C_ABC();
	
	/** Scenario: [A,B] -> listIterAddAfterPreviousA(C) -> [C,A,B]
	 * @return [C,A,B] after listIterAddAfterPreviousA(C)
	 */
	private IndexedUnsortedList<Integer> AB_listIterAddAfterPreviousA_C_CAB() {
		IndexedUnsortedList<Integer> list = A_addB_AB();
		ListIterator<Integer> it = list.listIterator(1);
		it.previous();
		it.add(ELEMENT_C);
	...
	private Scenario<Integer> AB_listIterAddAfterPreviousA_C_CAB = () -> AB_listIterAddAfterPreviousA_C_CAB();
	
	/** Scenario: [A,B] -> listIterAddAfterPreviousB(C) -> [A,C,B]
	 * @return [A,C,B] after listIterAddAfterPreviousB(C)
	 */
	private IndexedUnsortedList<Integer> AB_listIterAddAfterPreviousB_C_ACB() {
		IndexedUnsortedList<Integer> list = A_addB_AB();
		ListIterator<Integer> it = list.listIterator(2);
		it.previous();
		it.add(ELEMENT_C);
	...
	private Scenario<Integer> AB_listIterAddAfterPreviousB_C_ACB = () -> AB_listIterAddAfterPreviousB_C_ACB();
	
	
	/**
	 * SINGLE-TO-SINGLE THROUGH "SET"
	 */

	/** Scenario: [A] -> listIterSetAfterNextA(B) -> [B]
	 * @return [B] after listIterSetAfterNextA(B)
	 */
	private IndexedUnsortedList<Integer> A_listIterSetAfterNextA_B_B() {
		IndexedUnsortedList<Integer> list = emptyList_addA_A();
		ListIterator<Integer> it = list.listIterator();
		it.next();
		it.set(ELEMENT_B);
	...
	private Scenario<Integer> A_listIterSetAfterNextA_B_B = () -> A_listIterSetAfterNextA_B_B();
	
	/** Scenario: [A] -> listIterSetAfterPreviousA(B) -> [B]
	 * @return [B] after listIterSetAfterPreviousA(B)
	 */
	private IndexedUnsortedList<Integer> A_listIterSetAfterPreviousA_B_B() {
		IndexedUnsortedList<Integer> list = emptyList_addA_A();
		ListIterator<Integer> it = list.listIterator(1);
		it.previous();
		it.set(ELEMENT_B);
	...
	private Scenario<Integer> A_listIterSetAfterPreviousA_B_B = () -> A_listIterSetAfterPreviousA_B_B();
	
	
	/**
	 * DOUBLE-TO-DOUBLE THROUGH "SET"
	 */
	
	/** Scenario: [A,B] -> listIterSetAfterNextA(C) -> [C,B]
	 * @return [C,B] after listIterSetAfterNextA(C) 
	 */
	private IndexedUnsortedList<Integer> AB_listIterSetAfterNextA_C_CB() {
		IndexedUnsortedList<Integer> list = A_addB_AB();
		ListIterator<Integer> it = list.listIterator();
		it.next();
		it.set(ELEMENT_C);
	...
	private Scenario<Integer> AB_listIterSetAfterNextA_C_CB = () -> AB_listIterSetAfterNextA_C_CB();
	
	/** Scenario: [A,B] -> listIterSetAfterNextB(C) -> [A,C]
	 * @return [A,C] after listIterSetAfterNextB(C)
	 */
	private IndexedUnsortedList<Integer> AB_listIterSetAfterNextB_C_AC() {
		IndexedUnsortedList<Integer> list = A_addB_AB();
		ListIterator<Integer> it = list.listIterator(1);
		it.next();
		it.set(ELEMENT_C);
	...
	private Scenario<Integer> AB_listIterSetAfterNextB_C_AC = () -> AB_listIterSetAfterNextB_C_AC();
	
	/** Scenario: [A,B] -> listIterSetAfterPreviousA(C) -> [C,B]
	 * @return [C,B] after listIterSetAfterPreviousA(C)
	 */
	private IndexedUnsortedList<Integer> AB_listIterSetAfterPreviousA_C_CB() {
		IndexedUnsortedList<Integer> list = A_addB_AB();
		ListIterator<Integer> it = list.listIterator(1);
		it.previous();
		it.set(ELEMENT_C);
	...
	private Scenario<Integer> AB_listIterSetAfterPreviousA_C_CB = () -> AB_listIterSetAfterPreviousA_C_CB();
	
	/** Scenario: [A,B] -> listIterSetAfterPreviousB(C) -> [A,C]
	 * @return [A,C] after listIterSetAfterPreviousB(C)
	 */
	private IndexedUnsortedList<Integer> AB_listIterSetAfterPreviousB_C_AC() {
		IndexedUnsortedList<Integer> list = A_addB_AB();
		ListIterator<Integer> it = list.listIterator(2);
		it.previous();
		it.set(ELEMENT_C);
	...
	private Scenario<Integer> AB_listIterSetAfterPreviousB_C_AC = () -> AB_listIterSetAfterPreviousB_C_AC();
	
	
	/**
	 * TRIPLE-TO-TRIPLE THROUGH "SET"
	 */
	
	/** Scenario: [A,B,C] -> listIterSetAfterNextA(D) -> [D,B,C]
	 * @return [D,B,C] after listIterSetAfterNextA(D)
	 */
	private IndexedUnsortedList<Integer> ABC_listIterSetAfterNextA_D_DBC() {
		IndexedUnsortedList<Integer> list = AB_addC_ABC();
		ListIterator<Integer> it = list.listIterator();
		it.next();
		it.set(ELEMENT_D);
	...
	private Scenario<Integer> ABC_listIterSetAfterNextA_D_DBC = () -> ABC_listIterSetAfterNextA_D_DBC();
	
	/** Scenario: [A,B,C] -> listIterSetAfterNextB(D) -> [A,D,C]
	 * @return [A,D,C] after listIterSetAfterNextB(D)
	 */
	private IndexedUnsortedList<Integer> ABC_listIterSetAfterNextB_D_ADC() {
		IndexedUnsortedList<Integer> list = AB_addC_ABC();
		ListIterator<Integer> it = list.listIterator(1);
		it.next();
		it.set(ELEMENT_D);
	...
	private Scenario<Integer> ABC_listIterSetAfterNextB_D_ADC = () -> ABC_listIterSetAfterNextB_D_ADC();
	
	/** Scenario: [A,B,C] -> listIterSetAfterNextC(D) -> [A,B,D]
	 * @return [A,B,D] after listIterSetAfterNextC(D)
	 */
	private IndexedUnsortedList<Integer> ABC_listIterSetAfterNextC_D_ABD() {
		IndexedUnsortedList<Integer> list = AB_addC_ABC();
		ListIterator<Integer> it = list.listIterator(2);
		it.next();
		it.set(ELEMENT_D);
	...
	private Scenario<Integer> ABC_listIterSetAfterNextC_D_ABD = () -> ABC_listIterSetAfterNextC_D_ABD();
	
	/** Scenario: [A,B,C] -> listIterSetAfterPreviousA(D) -> [D,B,C]
	 * @return [D,B,C] after listIterSetAfterPreviousA(D)
	 */
	private IndexedUnsortedList<Integer> ABC_listIterSetAfterPreviousA_D_DBC() {
		IndexedUnsortedList<Integer> list = AB_addC_ABC();
		ListIterator<Integer> it = list.listIterator(1);
		it.previous();
		it.set(ELEMENT_D);
	...
	private Scenario<Integer> ABC_listIterSetAfterPreviousA_D_DBC = () -> ABC_listIterSetAfterPreviousA_D_DBC();
	
	/** Scenario: [A,B,C] -> listIterSetAfterPreviousB(D) -> [A,D,C]
	 * @return [A,D,C] after listIterSetAfterPreviousB(D)
	 */
	private IndexedUnsortedList<Integer> ABC_listIterSetAfterPreviousB_D_ADC() {
		IndexedUnsortedList<Integer> list = AB_addC_ABC();
		ListIterator<Integer> it = list.listIterator(2);
		it.previous();
		it.set(ELEMENT_D);
	...
	private Scenario<Integer> ABC_listIterSetAfterPreviousB_D_ADC = () -> ABC_listIterSetAfterPreviousB_D_ADC();
	
	/** Scenario: [A,B,C] -> listIterSetAfterPreviousC(D) -> [A,B,D]
	 * @return [A,B,D] after listIterSetAfterPreviousC(D)
	 */
	private IndexedUnsortedList<Integer> ABC_listIterSetAfterPreviousC_D_ABD() {
		IndexedUnsortedList<Integer> list = AB_addC_ABC();
		ListIterator<Integer> it = list.listIterator(3);
		it.previous();
		it.set(ELEMENT_D);
	...
	private Scenario<Integer> ABC_listIterSetAfterPreviousC_D_ABD = () -> ABC_listIterSetAfterPreviousC_D_ABD();
	...
	private void testTwoElementList(Scenario<Integer> scenario, String scenarioName, Integer[] contents, String contentsString) {
		...
		try {
			...
			printTest(scenarioName + "_testAddToFront", testAddToFront(scenario.build(), ELEMENT_X, Result.NoException));
			printTest(scenarioName + "_testAddToRear", testAddToRear(scenario.build(), ELEMENT_X, Result.NoException));
			printTest(scenarioName + "_testAddAfterA" + contentsString.charAt(0), testAddAfter(scenario.build(), contents[0], ELEMENT_X, Result.NoException));
			printTest(scenarioName + "_testAddAfterB" + contentsString.charAt(1), testAddAfter(scenario.build(), contents[1], ELEMENT_X, Result.NoException));
			printTest(scenarioName + "_testAddAfterX", testAddAfter(scenario.build(), ELEMENT_X, ELEMENT_Z, Result.NoSuchElement));
			printTest(scenarioName + "_testAdd", testAdd(scenario.build(), ELEMENT_X, Result.NoException));
			printTest(scenarioName + "_testAddAtIndexNeg1", testAddAtIndex(scenario.build(), -1, ELEMENT_X, Result.IndexOutOfBounds));
			printTest(scenarioName + "_testAddAtIndex0", testAddAtIndex(scenario.build(), 0, ELEMENT_X, Result.NoException));
			...
			printTest(scenarioName + "_iterNext_testIterRemove", testIterRemove(iterAfterNext(scenario.build(), 1), Result.NoException)); //NoException because no element argument passed
			...
			printTest(scenarioName + "_iterNextRemove_testIterRemove", testIterRemove(iterAfterRemove(iterAfterNext(scenario.build(), 1)), Result.IllegalState));
			printTest(scenarioName + "_iterNext2_testIterHasNext", testIterHasNext(iterAfterNext(scenario.build(), 2), Result.False));
			printTest(scenarioName + "_iterNext2_testIterNext", testIterNext(iterAfterNext(scenario.build(), 2), null, Result.NoSuchElement));
			printTest(scenarioName + "_iterNext2_testIterRemove", testIterRemove(iterAfterNext(scenario.build(), 2), Result.NoException));
			printTest(scenarioName + "_iterNext2Remove_testIterHasNext", testIterHasNext(iterAfterRemove(iterAfterNext(scenario.build(), 2)), Result.False));
			printTest(scenarioName + "_iterNext2Remove_testIterNext", testIterNext(iterAfterRemove(iterAfterNext(scenario.build(), 2)), null, Result.NoSuchElement));
	...
	private void testThreeElementList(Scenario<Integer> scenario, String scenarioName, Integer[] contents, String contentsString) {
		...
		try {
			...
			printTest(scenarioName + "_testAddAfterA" + contentsString.charAt(0), testAddAfter(scenario.build(), contents[0], ELEMENT_X, Result.NoException));
			printTest(scenarioName + "_testAddAfterB" + contentsString.charAt(1), testAddAfter(scenario.build(), contents[1], ELEMENT_X, Result.NoException));
			printTest(scenarioName + "_testAddAfterC" + contentsString.charAt(2), testAddAfter(scenario.build(), contents[2], ELEMENT_X, Result.NoException));
			printTest(scenarioName + "_testAddAfterX", testAddAfter(scenario.build(), ELEMENT_X, ELEMENT_Z, Result.NoSuchElement));
			printTest(scenarioName + "_testAdd", testAdd(scenario.build(), ELEMENT_X, Result.NoException));
			printTest(scenarioName + "_testAddAtIndexNeg1", testAddAtIndex(scenario.build(), -1, ELEMENT_X, Result.IndexOutOfBounds));
			printTest(scenarioName + "_testAddAtIndex0", testAddAtIndex(scenario.build(), 0, ELEMENT_X, Result.NoException));

 ...
 * 
 * @updated: 11/26/2020
 * @changelog: Added StringBuilder() functionality to improve Reader resource management
 */
...
public class Book implements BookInterface {
	...
	// Ensure none of the values of the Book are null, then ensure the provided
	// filename is correct
	...
	// Pull the associated text file from a Book object, parse it to a string,
	// return that string
		...
		if (this.isValid()) {
			...
			try {
				...
				while (bookReader.hasNextLine()) {
					extraCredit.append(bookReader.nextLine() + "\n");
				}
				bookReader.close();
	...
	public String toString() {
		String textOut = "";
		textOut += "Book Title: " + this.title + "; Author: " + this.author + "; Genre: " + this.genre + "; File Path: "
				+ this.filename;
		return textOut;
	}

...
public class BouncyBall extends JPanel
{
	...
	public BouncyBall()
	{
		...
		int redVal = new Random().nextInt(256);
		int bluVal = new Random().nextInt(256);
		int grnVal = new Random().nextInt(256);
		Color randoBall = new Color(redVal, bluVal, grnVal);
		color = randoBall;
		...
		int maxStartX = INIT_WIDTH - radius;
		int maxStartY = INIT_HEIGHT - radius;
		x = new Random().nextInt(maxStartX);
		y = new Random().nextInt(maxStartY);
